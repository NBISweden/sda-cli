...
expected="FileIDSizePathurn:neic:001-0011.0MBmain/subfolder/dummy_data.c4ghurn:neic:001-0021.0MBmain/subfolder2/dummy_data2.c4ghurn:neic:001-0031.0MBmain/subfolder2/random/dummy_data3.c4ghDatasetsize:3.1MB"
if [[ "${output//[$' \t\n\r']/}" == *"${expected//[$' \t\n\r']/}"* ]];  then
